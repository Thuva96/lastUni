                       ...
                       <div class="row items-center justify-start">
                        ...
                        <div class="row items-center justify-start">
                            ...
                            <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <input id="T_Cholestreol" type="number" class="form-control" name="T_Cholestreol">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group mb-3">
                        ...
                        <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <input id="Plan_on_discharge" type="date" class="form-control" name="Plan_on_discharge" placeholder="mm-dd-yyyy">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group mb-3">
