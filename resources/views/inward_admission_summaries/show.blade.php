        ...
        <div class="bg-dark overflow-hidden shadow-sm sm:rounded-lg mb-3" style="width: 500px;">
            <div class="card border-dark" style="margin:10px;">
                ...
                <div class="card-body text-dark">
                    ...
                    <div class="row">
                        <label class="col-sm-4 col-label-form"><b>Reason_For_Admission</b></label>
                        <div class="col">: {{$InwardAdmissionSummary->Reason_For_Admission}}</div>
                    </div>
                    <div class="row">
                        <label class="col-sm-4 col-label-form"><b>Acute_Problem</b></label>
                    ...
                    <div class="row">
                        <label class="col-sm-4 col-label-form"><b>special_Treatment</b></label>
