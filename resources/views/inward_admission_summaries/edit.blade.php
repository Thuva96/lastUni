                    ...
                    <form action="{{route('inward_admission_summaries.update' ,$InwardAdmissionSummary->id)}}" method="post">
                        ...
                        <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <input id="DOA" type="DOA" class="form-control" name="DOA" placeholder="mm-dd-yyyy">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group mb-3">
                                    <label for="DOD" class="form-label mb-1"><b>{{ __('DOD') }}</b></label>
                                    <input id="DOD" type="DOD" class="form-control" name="DOD" placeholder="mm-dd-yyyy">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group mb-3">
                                    <label for="BHT_NO" class="form-label mb-1"><b>{{ __('BHT_NO') }}</b></label>
                                    <input id="BHT_NO" type="text" class="form-control" name="BHT_NO" autocomplete="BHT_NO">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group mb-3">
                                    <label for="case_no" class="form-label mb-1"><b>{{ __('case_no') }}</b></label>
                                    <input id="case_no" type="text" class="form-control" name="case_no" autocomplete="case_no">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group mb-3">
                                    <label for="Reason_For_Admission" class="form-label mb-1"><b>{{ __('Reason_For_Admission') }}</b></label>
                                    <input id="Reason_For_Admission" type="text" class="form-control" name="Reason_For_Admission" autocomplete="Reason_For_Admission">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group mb-3">
                                    <label for="Acute_Problem" class="form-label mb-1"><b>{{ __('Acute_Problem') }}</b></label>
                        ...
                        <div class="row items-center justify-start">
                           <div class="col">
                                <div class="form-group mb-3">
                                    <label for="Special_Treatment" class="form-label mb-1"><b>{{ __('Special_Treatment') }}</b></label>
